...
num_spherical_battery_packs_required = ceiling(packed_battery_pack_volume / ((4.0 / 3.0) * pi * pow(0.5 * vehicle_inner_diameter * INTERNAL_MODULE_PACKING_FACTOR, 3.0)))
...
wing_x_right = wing_x_left + wing_root_chord
...
constraints = PointFunc({
   ...
   "vehicle_pushing_force": vehicle_dry_mass_stage2 * 0.01 * GRAVITATIONAL_CONSTANT <= maximum_buoyancy_required,
})
